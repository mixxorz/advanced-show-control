...
mod tests {
    ...
    fn scene_config_serializes_internal_id_and_nullable_scene_index() {
        let internal_scene_id = Uuid::parse_str("11111111-1111-4111-8111-111111111111").unwrap();
    ...
    #[test]
    fn scene_config_serializes_pan_family_fields_in_camel_case() {
        let config = SceneConfig {
    ...
    #[test]
    fn scene_config_serializes_no_pan_mode_in_camel_case() {
        let config = SceneConfig {
