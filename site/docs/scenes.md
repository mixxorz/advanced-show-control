...
Scope selects the channels and controls that can change during the fade. Storing values does not select them automatically.
...
| **Store** | Records the current fader and pan values. |
